...
::
:: Ejemplos:  auto \bases\test\biblio
...
set MAIN_ENTRY=v100~v110~v111~v130
set ADDED_ENTRY=v700~v710~v711~v730
set SERIES=v440~v800~v810~v811~v830
set SUBJECT1=v600~v610~v611~v630
...
if not exist %WORK%\nul if not exist %WORK%nul mkdir %WORK%
%CHECK_ERROR%_MKDIR
del /Q %WORK%\*.*
if not exist %OUTPUT%\nul  if not exist %OUTPUT%nul  mkdir %OUTPUT%
%CHECK_ERROR%_MKDIR
del /Q %OUTPUT%\*.*
...
mxtb %WORK%\auto-uniq create=%WORK%\tag-freq 3:v3
msrt %WORK%\tag-freq 3 v1
mx %WORK%\tag-freq "pft=v1,c10,v999/" now >%OUTPUT%\tag-freq.txt
